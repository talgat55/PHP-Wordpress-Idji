...
get_header(); ?>
    <section id="first-section-service" style="height: auto;">
        <div class="container clearfix">
            ...
            <div class="feature-service fl-service clearfix" >
                <div class="feature-service-img">
                    <img data-src="<?php echo get_theme_file_uri('/assets/images/warning2-2.png') ?>">
                </div>
                <p>
                    Начав процедуру банкротства с Иджис, Вы забудете о преследовании кредиторов, судебных приставов и коллекторов и сможете вздохнуть полной грудью!
                </p>
            </div>
     ...
     <a href="#">
       <img src="<?php echo get_theme_file_uri('/assets/images/schema-2.png') ?>">
            ...
            <div class="five-step-block-bottom">
                <p>
                    Минимальный срок процедуры банкротства гражданина — <b>4 месяцев</b>, в среднем же он
                    составляет <b>6 месяцев</b> в случае утверждения процедуры реализации имущества, и <b>12 месяцев</b> -
