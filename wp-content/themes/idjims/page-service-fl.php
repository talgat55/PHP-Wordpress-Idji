 ...
 <section id="first-section-service" style="height: auto;">
   <div class="container clearfix">
     ...
     <div class="col-md-3  z-up">
       ...
       <img  src="<?php  echo get_theme_file_uri( '/assets/images/human3-2.png' ) ?>">
     ...
     <div class="col-md-9">
        ...
        <p>
          ...
          Когда становится очевидным, что расплатиться с долгами невозможно, а их размер растет как снежный ком, увеличиваясь за счет процентов и неустоек. Начать банкротство можно при ЛЮБОЙ сумме долга.
        </br>
        </br>
          <b>Важно:</b>  Объявить себя банкротом поручитель ОБЯЗАН тогда, когда его общий долг превышает 500 тысяч рублей, а рассчитаться со всеми долгами он не может.
        </br>
        </br>
        ...
        <p class="with-quote">
          «Гражданин <b>обязан</b> обратиться в арбитражный суд с заявлением о признании его банкротом в случае, если удовлетворение требований одного кредитора или нескольких кредиторов приводит к невозможности исполнения гражданином денежных обязательств в полном объеме перед другими кредиторами и размер таких обязательств и обязанности в совокупности составляет не менее чем пятьсот тысяч рублей»
        </p>
        </br>
        <p class="with-quote">
     ...
     <div class="feature-service-one z-up clearfix">
       <img  src="<?php  echo get_theme_file_uri( '/assets/images/weight-2.png' ) ?>">
          <div>
            <h3>Наша практика</h3>
           <p>
             Судебная практика нашей компании показала, что судьи при решении вопроса о списании долгов занимают сторону поручителей, т.к. по сути это не Ваши долги и заемными деньгами Вы не распоряжались. Это значит, что в глазах суда и кредиторов Вы – добросовестный должник, к Вам отнесутся с пониманием и не будут задавать лишних вопросов.
     ...
     <div class="feature-service z-up clearfix">
       ...
       <p>
         <span>Главная особенность банкротства должника по ипотеке</span> — финансирование процедуры за счет вырученных с продажи дома или квартиры средств. Теперь не нужно влезать еще в большие долги, чтобы решить проблемы с ипотечным долгом!
       </p>
     </div>
...
<img class="home-img"   src="<?php  echo get_theme_file_uri( '/assets/images/home3-2.png' ) ?>">
 </section>
