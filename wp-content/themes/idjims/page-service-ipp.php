...
get_header(); ?>
    <section id="first-section-service" style="height:auto; ">
        <div class="container clearfix">
            <h1 class="title-section service center-white ">Банкротство ИП <?= $city['name_rod']; ?></h1>
            <div class="clearfix">
                <div class="col-md-3">
            ...
            <div class="feature-service ind-p-sevice  clearfix">
        ...
        <div class="container">
            ...
            <div class="clearfix">
                ...
                <div class="Plus-minus-block clearfix">
                    ...
                    <p>
                        Если у Вас еще есть шанс исправить свое финансовое положение, и Вы готовы платить кредиты по
                ...
                <div class="Plus-block clearfix">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="plus-minus-block-bottom"><img
                                    data-src="<?php echo get_theme_file_uri('/assets/images/emojii-2.png') ?>"> При
                            этом
                ...
                <div class="plus-minus-block-bottom-wallpaper clearfix">
                    ...
                    <div class="col-md-8">
                        <p>
                            <b>Мы предоставим Вам финансового управляющего,</b> который не только будет вести Ваше
                            дело,
