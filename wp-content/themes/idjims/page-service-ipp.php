<?php
/**
 *  Template Name: Service Page Individual PP
 */
get_header(); ?>
    <section id="first-section-service" style="height:auto; ">
        <div class="container clearfix">
            <h1 class="title-section service center-white ">Банкротство ИП</h1>
            <div class="clearfix">
                <div class="col-md-3">
                ...
                <div class="col-md-9 z-up">
                    <h3>Банкротство индивидуальных предпринимателей — законный способ оставить в прошлом прогоревший
                        бизнес и повлекшиеся за ним долги.</h3>

                    <h3 style="color:white;    padding-top: 10px;">В каком случае индивидуальный предприниматель может
                        объявить себя банкротом:</h3>
                    <p>
                        Когда становится очевидным, что расплатиться с личными долгами и долгами от предпринимательской
                        деятельности невозможно, а их размер растет как снежный ком, увеличиваясь за счет процентов и
                        неустоек. Начать банкротство можно при ЛЮБОЙ сумме долга.
                        </br>
                        </br>
                        Важно: Объявить себя банкротом индивидуальный предприниматель ОБЯЗАН тогда, когда его общий долг
                        превышает 500 тысяч рублей, а рассчитаться со всеми долгами он не может.
                        </br>
                        </br>
                        Невыполнение этого требования может повлечь административную и уголовную ответственность!
                    </p>
                    </br>
                    ...
                    <div class="accrotdions-blocks">
                        ...
                        <div>
                            ...
                            <p class="with-quote">
                                «Гражданин обязан обратиться в арбитражный суд с заявлением о признании его банкротом в
                                случае, если удовлетворение требований одного кредитора или нескольких кредиторов
                                приводит к невозможности исполнения гражданином денежных обязательств в полном объеме
                                перед другими кредиторами и размер таких обязательств и обязанности в совокупности
                                составляет не менее чем пятьсот тысяч рублей»
                            </p>
                            </br>
                            <p class="with-quote">
                                В соответствии со ст. 195 УК РФ за действия, связанные с несвоевременным объявлением о
                                своем банкротстве, могут лишить свободы на срок до 3 лет со штрафом до 200 тыс. руб.
                            </p>
                        </div>
            ...
            <div class="feature-service-one z-up clearfix">
                <div class="feature-service-img">
                    <img data-src="<?php echo get_theme_file_uri('/assets/images/weight-2.png') ?>">
                </div>
                <div>
                    <h3>Наша практика</h3>
                    <p>
                        Судебная практика нашей компании показала, что до принятия закона о банкротстве физлиц
                        единственной для гражданина возможностью списать свои долги была регистрация ИП с последующим
                        банкротством, цена которого составляла от 30 тыс. руб. в месяц. Сегодня индивидуальные
                        предприниматели могут объявить о своем банкротстве в таком же порядке и с такими же расходами,
                        как и обычные граждане.
                        </br>
                        </br>
                        Кроме того, в суде к Вам отнесутся с пониманием и не будут задавать лишних вопросов, т.к.
                        банкротство ИП – случай заурядный, не каждый бизнес выстоит в кризис.
                    </p>
                </div>
            </div>
        ...
        <div class="container clearfix">
            ...
            <div class="clearfix">
                ...
                <div class="col-md-6  dont-wait-block-auto-height no-padding-right">
                    <div class="dont-wait-block">
                        <div class="dont-wait-img">
                            <img data-src="<?php echo get_theme_file_uri('/assets/images/dontwait2-2.png') ?>">
                        </div>
                        <p>
                            Войти в прежний график будет все сложнее, ведь долг станет только больше. Кредитные каникулы
                            лишь усугубят ситуацию, лишив последней надежды сохранить имущество
                        </p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="dont-wait-block" style="padding: 35px 174px;">
                        <div class="dont-wait-img">
    ...
    <section id="five-step" class="service-page-five-step">
     ...
     <a href="#">
       <img data-src="<?php echo get_theme_file_uri('/assets/images/schema-2.png') ?>">
            ...
            <div class="five-step-block-bottom">
                <p>
                    Минимальный срок процедуры банкротства ип — <b>10 месяцев</b>, в среднем же он
    ...
    <section id="Plus-minus">
        <div class="container">
            <div class="title-section center">Плюсы и минусы <span class="red">банкротства</span> ИП</div>
            <div class="clearfix">

                <div class="Plus-minus-block clearfix">
                    <h3>При процедуре реструктуизации долгов</h3>
                    <p>
                        Если у Вас еще есть шанс исправить свое финансовое положение, и Вы готовы платить ипотеку по
                        новым условиям, Ваш идеальный вариант — реструктуризация долгов путем банкротства.
                    </p>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="col-md-plus-block">
                            ...
                            <p>
                                ...
                                реструктуризация пройдет под 8,5% годовых.
                            </p>
                        </div>
                    </div>
                ...
                <div class="Plus-block clearfix">
                    <div class="clearfix">
                        <h3>При процедуре реализации имущества</h3>
                        <p>
                            Если в ближайшее время нет шанса вернуться к выплатам, Вы можете решить проблему путем
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="plus-minus-block-bottom"><img
                                    data-src="<?php echo get_theme_file_uri('/assets/images/emojii-2.png') ?>"> При этом
                            виде банкротства реализуют залог
                        </div>
                ...
                <div class="plus-minus-block-bottom-wallpaper clearfix">
                    <div class="col-md-4 center">

                        <img data-src="<?php echo get_theme_file_uri('/assets/images/bg-block-2.png') ?>">
                    </div>
                    <div class="col-md-8">
                        <p>
                            <b>Мы предоставим Вам финансового управляющего,</b> который не только будет вести Ваше дело,
                            но и обеспечит стратегическое преимущество в процессе банкротства.
                        </p>
                    </div>
    ...
    <section id="Myth">
        <div class="container relative">
            ...
            <div class="clearfix myth-custom-margin">
                ...
                <div class="col-md-4 center animation-block  opacity-zero"  data-animation="flipInY">
                    <div class="myth-block-alt">
                        <img data-src="<?php echo get_theme_file_uri('/assets/images/myth-resume-2.png') ?>">
                        <p>Лишаетесь статуса индивидуального предпринимателя</p>
                    </div>
                </div>

                <div class="col-md-4 center animation-block  opacity-zero"  data-animation="flipInY">
                    <div class="myth-block-alt">
                        <img data-src="<?php echo get_theme_file_uri('/assets/images/myth-global-2.png') ?>">
                        <p>Обязаны сообщить о своем намерении банкротиться путем размещения соответствующей информации в
                            реестре сведений. </p>
                    </div>
                </div>
                <div class="col-md-4 center no-padding-right animation-block  opacity-zero"  data-animation="flipInY">
                    <div class="myth-block-alt">
                        <img data-src="<?php echo get_theme_file_uri('/assets/images/myth-cal5-2.png') ?>">
                        <p>В течение 5-ти лет нельзя снова регистрировать ИП</p>
                    </div>
                </div>
            ...
            <div class="clearfix">
                ...
                <div class="col-md-6 live-idji-walp no-padding-right">
                    <div class="live-idji-block">
                        ...
                        <p>
                            Предоставим независимого финансового управляющего, который поможет выйти Вам с наиболее
                ...
                <div class="col-md-6 live-idji-walp">
                    <div class="live-idji-block">
                        ...
                        <p>
                            Соберем все необходимые документы, составим и направим запросы в ведомства.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 live-idji-walp no-padding-right">
                    <div class="live-idji-block">
                        ...
                        <p>
                            Проконтролируем процесс подачи заявления в арбитражный суд, будем представлять Ваши интересы
