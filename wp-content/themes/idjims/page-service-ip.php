 ...
 <section id="first-section-service">
   <div class="container clearfix">
     ...
     <div class="col-md-9 z-up">
        ...
        <p>
          1. Хочет сохранить залоговое имущество, честно выплатив долги без грабительских процентов в ходе процедуры банкротства - реструктуризации
          </br>
          2. Не может погасить ипотечный долг, но хочет выйти из ситуации с минимальными потерями, пройдя процедуру банкротства - реализацию имущества
        </p>
    ...
    <p class="calibri">
      Если в ближайшее время Вы не найдете способ вернуться к платежам, то стоит воспользоваться процедурой банкротства. Иначе могут начаться необратимые последствия:
       ...
       <div class="col-md-6  dont-wait-block-auto-height">
         <div class="dont-wait-block">
            <img  src="<?php  echo get_theme_file_uri( '/assets/images/dontwait3-2.png' ) ?>">
             <p>
              Банк подаст иск в суд уже спустя 3 месяца просрочки платежей, или же когда сумма задолженности превысит 5% от суммы залога. Ваш дом продадут по самой низкой цене, о оставшуюся задолженность все равно придется выплачивать.
             </p>
         </div>
       </div>
       <div class="col-md-6  dont-wait-block-auto-height no-padding-right">
         <div class="dont-wait-block">
            <img  src="<?php  echo get_theme_file_uri( '/assets/images/dontwait4-2.png' ) ?>">
             <p>
               Прописка несовершеннолетних в ипотечном жилье также не спасет ситуацию. Детей выселят на основании решения суда, а сам дом продадут, оставив без крыши над головой.
            </p>
         </div>
       </div>
       </div>
       <div class="dont-wait-block-bottom">
           <p>
             <b>СПАСИТЕ СВОЕ ЖИЛЬЕ</b> — НАЧНИТЕ ПРОЦЕДУРУ БАНКРОТСТВА РАНЬШЕ, ЧЕМ БАНК ПОДАСТ ИСК. ТОЛЬКО ТАК ВЫ СОХРАНИТЕ СВОЙ ДОМ И СМОЖЕТЕ ИЗБАВИТЬСЯ ОТ ГРАБИТЕЛЬСКОГО ПРОЦЕНТА БАНКА
            </p>
       </div>
