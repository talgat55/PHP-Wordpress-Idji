...
get_header(); ?>
            ...
            <div>
                <div class="col-md-3 benefit-cols animation-block  opacity-zero" data-animation="slideInUp">
                    <div class="benefit-block">
                        ...
                        <p>Работая с нашим управляющим напрямую, вы избегаете финансовых издержек, навязываемых
                            посредниками.</p>
                    </div>
                </div>
                <div class="col-md-3 benefit-cols animation-block  opacity-zero" data-animation="slideInUp">
                    <div class="benefit-block">
                        ...
                        <p>Арбитражный управляющий - эксперт по банкротству, работа с которым— гарантия успешного
                ...
                <div class="col-md-3  benefit-cols no-padding-right animation-block  opacity-zero"
                    ...
                    <div class="benefit-block">
                        ...
                        <p>Мы заботимся о своих клиентах и знаем, с какими финансовыми трудностями им пришлось
                ...
                <div class="col-md-3 benefit-cols no-padding-right animation-block  opacity-zero"
                    ...
                    <div class="benefit-block">
                        ...
                        <p>Заявление о банкротстве, ходатайства, возражения, отзывы и дополнения, справки и
                            доверенности, запросы и переписка с кредиторами— за Вас все это сделает наш профессиональный
                            юрист!</p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div>
                        <div class="col-md-2 margin-top">
                            ...
                            <img data-src="<?php echo get_theme_file_uri('/assets/images/feedback-2.jpg') ?>">
                        </div>
                        <div class="col-md-10  block-text-how-we-work margin-top">
                            <h3>Оставьте заявку</h3>
                            <p>Сделать это можно, позвонив по телефону <a href="tel:89235374767" class="linkInText">8-923-537-47-67</a>,
                            ...
                            <h3>Результат</h3>
                            <p>Вы получите возможность посетить бесплатную консультацию. Обычная цена такой консультации
                                - 1800 рублей.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="col-md-2 margin-top">
                            ...
                            <img data-src="<?php echo get_theme_file_uri('/assets/images/feedback2-2.jpg') ?>">
                        </div>
                        <div class="col-md-10  block-text-how-we-work margin-top">
                            ...
                            <p>В ходе бесплатной консультации Вам подробно расскажут о банкротстве граждан и подарят
                                ...
                                и выробатывает рекомендации относительно дальнейших действий, а также о том, как
                                правильно выбрать компанию по банкротству.</p>
                            <h3>Результат</h3>
                    ...
                    <div>
                        <div class="col-md-2 margin-top">
                            ...
                            <img data-src="<?php echo get_theme_file_uri('/assets/images/feedback3-2.jpg') ?>">
                        </div>
                        <div class="col-md-10  block-text-how-we-work margin-top">
                    ...
                    <div>
                        <div class="col-md-2 margin-top">
                            ...
                            <img data-src="<?php echo get_theme_file_uri('/assets/images/feedback4-2.jpg') ?>">
                        </div>
                        <div class="col-md-10  block-text-how-we-work margin-top">
                            <h3>Мы решим Вашу проблему с долгами!</h3>
                            <p>В ходе проведения процедуры мы постоянно будем держать Вас в курсе всех дел. По Вашему
                                желанию, наш юрист будет представлять Ваши интересы в суде. После окончания
            ...
            <div class="clearfix">
                <div class="col-md-7">
                    <div class="title-offer-list clearfix">
                        <img data-src="<?php echo get_theme_file_uri('/assets/images/cube-2.jpg'); ?>">
                        <h3>Исключаем:</h3>
                    </div>
                    <ul class="offer-list">
                        <li>
                            <div class="offer-img">
                                ...
                                <img data-src="<?php echo get_theme_file_uri('/assets/images/check-red-2.jpg') ?>">
                            </div>
                            <p>Долги по кредитам перед банками</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-red-2.jpg') ?>">
                            </div>
                            <p>Долги перед микрофинансовыми организациями</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-red-2.jpg') ?>">
                            </div>
                            <p>Исполнительные производства и связанные с ними аресты имущества, взыскания из заработной
                                платы</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-red-2.jpg') ?>">
                            </div>
                            <p>Давление кредиторов</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-red-2.jpg') ?>">
                            </div>
                            <p>Преследование коллекторами</p></li>
                    </ul>
                </div>

                <div class="col-md-5">
                    <div class="title-offer-list clearfix">
                        <img data-src="<?php echo get_theme_file_uri('/assets/images/save-2.jpg') ?>">
                        <h3>Сохраняем:</h3>
                    </div>
                    <ul class="offer-list">
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-blue-2.jpg') ?>">
                            </div>
                            <p>Ваш дом или квартиру</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-blue-2.jpg') ?>">
                            </div>
                            <p>Вашу мебель и бытовую технику</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-blue-2.jpg') ?>">
                            </div>
                            <p>Вашу заработную плату</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-blue-2.jpg') ?>">
                            </div>
                            <p>Ваше душевное спокойствие</p></li>
                        <li>
                            <div class="offer-img"><img
                                        data-src="<?php echo get_theme_file_uri('/assets/images/check-blue-2.jpg') ?>">
                            </div>
                            <p>Ваше финансовое благополучие</p></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-12 ">
                ...
                <div class="block-warning">
                    <img class="img-warn" data-src="<?php echo get_theme_file_uri('/assets/images/warning-2.png') ?>">
                    <p><b>Важно:</b> Объявить себя банкротом гражданин <b>ОБЯЗАН</b> тогда, когда его общий долг
                        ...
                        рассчитаться со всеми кредитами в установленный срок невозможно</p>

                    <img class="check-bg" data-src="<?php echo get_theme_file_uri('/assets/images/check-bg-2.png'); ?>">
                </div>
    ...
    <section id="OurService">
        <div class="container relative">
            ...
            <div class="col-md-12 relative ourservice-last-block">
