    ...
    <table style="border: none; width: 100%; " cellpadding="5">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 40%;">' . $results[0]->first_name . ' ' . $results[0]->second_name . ' ' . $results[0]->third_name . '<br>Место жительства: '.$results[0]->place_live.', Выдан  '.date("d.m.y", strtotime($results[0]->passport_issued_date)).'  '.$results[0]->passport_issued_by.'  '.$results[0]->passport_issued_key.', '.$results[0]->registrtation_city.', '.$results[0]->registrtation_locality.',  '.$results[0]->registrtation_street.', д. '.$results[0]->registrtation_number_hourse.', кв. '.$results[0]->registrtation_number_housing.'<br>тел: '.$results[0]->extra_phone.'
                </td>
            </tr>
        </tbody>
        </table>
...
- о наличии и размере как текущей, так и просроченной задолженности по
вышеуказанному Договору;<br>
- даты и размеры произведенных и предстоящих платежей по вышеуказанному Договору.
<br> Запрашиваемую справку прошу направить письмом по почтовому адресу, указанному мной в
настоящем заявлении в срок, не превышающий 7 (семь) календарных дней с момента получения
Вами настоящего заявления.
<br> Обращаю Ваше внимание, что запрашиваемая мной информация в рамках Договора, согласно
нормам Федерального закона от 21.12.2013 N 353-ФЗ «О потребительском кредите (займе)»
предоставляется заёмщику бесплатно.
<br> Так же прошу бесплатно предоставить заверенную Вами копию вышеуказанного Договора
...
<br> Запрашиваемую копию Договора (документов, на основании которых возникло соответствующее
обязательство) также прошу направить письмом по почтовому адресу, указанному мной в
настоящем заявлении в срок, не превышающий 7(семь) календарных дней с момента получения
Вами настоящего заявления.
<br> <strong>Обращаю Ваше внимание,</strong> что предоставленные письменные разъяснения о невозможности
