   ...
   // $cur_user_id = 1;
    ...
    $html = '
        ...
        <table border="1" cellspacing="0" cellpadding="0" align="left" width="100%" cellpadding="5">
            <tbody>
                ...
                <tr>
                    ...
                    <td   width="20%" valign="middle">
                      ' . $results[0]->passport_number. '   ' . $results[0]->passport_serial. '
                    </td>
                </tr>
                <tr>
                    <td   colspan="3" valign="middle">
       ...
       <div>
                ...
                <strong>_____</strong><br><span style="color: #fff;">wdaw</span>* При отсутствии регистрации по месту жительства в пределах Российской
    ...
    <br><span style="color: #fff;">wdaw</span><sup>1</sup><span style="color: #fff;">w</span>Указывается вид собственности (индивидуальная, долевая, общая); для совместной собственности указываются иные лица (фамилия, имя и отчество (последнее - при наличии) или
    ...
    <br><span style="color: #fff;">wdaw</span><sup>2</sup><span style="color: #fff;">w</span>Указываются наименование и реквизиты документа, являющегося законным основанием для возникновения права собственности.
    <br><span style="color: #fff;">wdaw</span><sup>3</sup><span style="color: #fff;">w</span>Указывается при наличии документов, содержащих сведения о стоимости имущества (например, отчет о стоимости имущества, подготовленный оценщиком, договор купли-продажи, иной
    документ об оплате (приобретении) имущества).
    <br><span style="color: #fff;">wdaw</span><sup>4</sup><span style="color: #fff;">w</span>Указываются сведения о договоре залога, иной сделке, на основании которой возникает залог в силу закона, а также наименование юридического лица или фамилия, имя и отчество
    (последнее - при наличии) физического лица, в залоге у которого находится имущество.
    <br><span style="color: #fff;">wdaw</span><sup>5</sup><span style="color: #fff;">w</span>Указывается вид земельного участка (пая, доли): под индивидуальное жилищное строительство, дачный, садовый, приусадебный, огородный и другие.
     </div>
    ';
    ...
    $html .= '
        ...
        <div  style="text-align: justify;">
        <br><span style="color: #fff;">wdaw</span><sup>6</sup><span style="color: #fff;">w</span>Указывается при наличии у движимого имущества цифрового, буквенного обозначения или комбинации таких обозначений, которые идентифицируют указанное имущество, в том числе
        идентификационный номер транспортного средства (VIN).
        <br><span style="color: #fff;">wdaw</span><sup>7</sup><span style="color: #fff;">w</span>Указывается вид собственности (индивидуальная, долевая, общая); для совместной собственности указываются иные лица (фамилия, имя и отчество (последнее - при наличии) или
        наименование), в собственности которых находится имущество; для долевой собственности указывается доля гражданина, который составляет опись имущества.
        <br><span style="color: #fff;">wdaw</span><sup>8</sup><span style="color: #fff;">w</span>Указывается при наличии документов, содержащих сведения о стоимости имущества (например, отчет о стоимости имущества, подготовленный оценщиком, договор купли-продажи, кассовый
        чек, товарный чек, иной документ об оплате (приобретении) имущества).
        <br><span style="color: #fff;">wdaw</span><sup>9</sup><span style="color: #fff;">w</span>Указываются сведения о договоре залога, иной сделке, на основании которой возникает залог в силу закона, а также наименование юридического лица или фамилия, имя и отчество
        (последнее - при наличии) физического лица, в залоге у которого находится имущество.
        </div>
    ...
    $html .= '    
        ...
        <div  style="text-align: justify;">
        <br><span style="color: #fff;">wdaw</span><sup>10</sup><span style="color: #fff;">w</span>Указывается вид счета (например, депозитный, текущий, расчетный, ссудный) и валюта счета.
        <br><span style="color: #fff;">wdaw</span><sup>11</sup><span style="color: #fff;">w</span>Остаток на счете указывается по состоянию на дату составления описи имущества гражданина. Для счетов в иностранной валюте остаток указывается в рублях по курсу Банка России на
    ...
    $html .= '    
        ...
        <strong>_____</strong><br>
        <div  style="text-align: justify;">
        <br><span style="color: #fff;">wdaw</span><sup>12</sup><span style="color: #fff;">w</span>Указываются полное или сокращенное официальное наименование организации и ее организационно-правовая форма (например, акционерное общество, общество с ограниченной
        ответственностью, полное товарищество, товарищество на вере, производственный кооператив, хозяйственное партнерство).
         <br><span style="color: #fff;">wdaw</span><sup>13</sup><span style="color: #fff;">w</span>Указывается согласно учредительным документам организации по состоянию на дату составления описи имущества гражданина. Суммы, выраженные в иностранной валюте, указываются в
        рублях по курсу Банка России на дату составления описи имущества гражданина.
        <br><span style="color: #fff;">wdaw</span><sup>14</sup><span style="color: #fff;">w</span>Указывается доля участия в уставном, складочном капитале, паевом фонде. Для акционерных обществ указываются также номинальная стоимость и количество акций.
        <br><span style="color: #fff;">wdaw</span><sup>15</sup><span style="color: #fff;">w</span>Указываются основание приобретения доли участия (например, учредительный договор, приватизация, покупка, мена, дарение, наследование), а также реквизиты (дата, номер)
    ...
    $html .= '    
        ...
        <strong>_____</strong><br>
        <div style="text-align: justify;">
        <br><span style="color: #fff;">wdaw</span><sup>16</sup><span style="color: #fff;">w</span>Указываются все ценные бумаги по видам (например, облигации, векселя), за исключением акций, указанных в разделе IV "Акции и иное участие в коммерческих организациях".
        <br><span style="color: #fff;">wdaw</span><sup>17</sup><span style="color: #fff;">w</span>Указывается общая стоимость ценных бумаг данного вида исходя из стоимости их приобретения (если ее нельзя определить - исходя из рыночной стоимости или номинальной стоимости).
    ...
    $html .= '
        ...
        <strong>_____</strong><br>
         <div  style="text-align: justify;">
        <br><span style="color: #fff;">wdaw</span><sup>18</sup><span style="color: #fff;">w</span>В отношении наличных денежных средств в валюте указывается сумма по курсу Банка России на дату подачи заявления о признании должника банкротом, в отношении иного указывается при
        ...
        <br><span style="color: #fff;">wdaw</span><sup>19</sup><span style="color: #fff;">w</span>Указываются сведения о договоре хранения ценностей в индивидуальном банковском сейфе (ячейке) и наименование кредитной организации.
        <br><span style="color: #fff;">wdaw</span><sup>20</sup><span style="color: #fff;">w</span>Указываются сведения о договоре залога, иной сделке, на основании которой возникает залог в силу закона, а также наименование юридического лица или фамилия, имя и отчество
        (последнее - при наличии) физического лица, в залоге у которого находится имущество.<br><br>
        Достоверность и полноту настоящих сведений подтверждаю.<br>
        </div>
      <table  nobr="true" style="border: none; width: 100%; " cellpadding="0">
        <tbody>
            <tr>
                <td style="width: 33.33%;"> «__» ___________ 20<span style="text-decoration: underline;"> ' . date("y") . ' </span> г.</td>
                <td style="width: 33.33%;text-align: center;">__________________</td>
                <td style="width: 33.33%;text-align: center;">_____________________</td>
            </tr>
             <tr>
                
                <td style="width: 33.33%;"><span style="font-size:10px; color:#fff;">(подпись гражданина)</span></td> 
                <td style="width: 33.33%;text-align: center;"><span style="font-size:10px; font-style: italic;">(подпись гражданина)</span></td> 
                <td style="width: 33.33%;  text-align: center;"><span style="font-size:10px; font-style: italic;">(расшифровка подписи)</span></td> 
            </tr>
